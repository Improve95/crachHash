...
public interface ManagerFeignClient {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/api/hash/task/progress/increase")
    void increaseTaskProgress(@RequestBody AddWorkerTaskProgressRequest request);
}
